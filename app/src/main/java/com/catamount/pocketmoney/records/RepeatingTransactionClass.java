...
import com.catamount.pocketmoney.views.repeating.LocalNotificationRepeatingReciever;
...
public class RepeatingTransactionClass extends PocketMoneyRecordClass implements Serializable {
    ...
    public void postAndAdvanceTransaction() {
        ...
        setupNotification(PocketMoney.getAppContext());
    }
    ...
    public void deleteFromDatabase() {
        if (this.repeatingID != 0) {
            ((NotificationManager) PocketMoney.getAppContext().getSystemService(Context.NOTIFICATION_SERVICE)).cancel(this.repeatingID);
