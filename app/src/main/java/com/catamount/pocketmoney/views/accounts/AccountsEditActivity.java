...
import com.catamount.pocketmoney.misc.ExchangeRateCallbackInterface;
...
public class AccountsEditActivity extends PocketMoneyActivity implements ExchangeRateCallbackInterface {
    ...
    public void copyDB() {
        try {
            copyFile(new File(Environment.getDataDirectory() + "/data/com.catamount.pocketmoney/databases/PocketMoneyDB.sql"), new File(PocketMoney.getExternalPocketMoneyDirectory(), "databasedata"));
        } catch (IOException e) {
