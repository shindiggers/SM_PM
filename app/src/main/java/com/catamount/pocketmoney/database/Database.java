...
public class Database {
    ...
    private static final String DATABASE_NAME = "PocketMoneyDB.sql";
    ...
    private static void execSqlWithCatch(String statement) {
        try {
            ...
            Log.i(PocketMoney.TAG, e.getLocalizedMessage());
        }
    }
    ...
    public static SQLiteDatabase currentDB() {
        if (dbh == null) {
            dbh = new DatabaseHelper(PocketMoney.getAppContext());
        }
        if (db == null) {
    ...
    public static void populateDatabaseDefaults(Context context) {
        ...
        if (CategoryClass.idForCategory(PocketMoney.getAppContext().getString(R.string.kLOC_DEFAULTCATEGORIES1)) <= 0) {
            int i2;
    ...
    public static void sqlite3_begin() {
        try {
            ...
            Log.e(PocketMoney.TAG, "sql error begining a new transaction");
        }
    }
    ...
    public static void sqlite3_commit() {
        try {
            ...
            Log.e(PocketMoney.TAG, "sql error commiting a transaction");
        }
    }
    ...
    public static void sqlite3_rollback() {
        try {
            ...
            Log.e(PocketMoney.TAG, "sql error rollingback a transaction");
        }
    }
    ...
    public static PocketMoneyRecordClass[] queryServerSyncTableWithPKandClassAndTime(String table, String primaryKey, Class<? extends PocketMoneyRecordClass> aClass, long lastSyncTime) {
        ...
        try {
            ...
            Log.e(PocketMoney.TAG, e2.getLocalizedMessage());
            e2.printStackTrace();
        }
        while (c.moveToNext()) {
            try {
                ...
                Log.e(PocketMoney.TAG, e3.getLocalizedMessage());
                e3.printStackTrace();
            }
            foundRecords.add(pm);
        }
