...
public class AccountTypeIconGridActivity extends PocketMoneyActivity {
    private static String[] icons = new String[]{
            "ic_barclays_icon.xml",
            "ic_hsbc_icon.xml",
            "ic_axa.xml",
            "ic_bitcoin_icon.xml",
            "ic_visa.xml",
            "ic_bankofamerica_icon.xml",
            "ic_nabcomau_icon.xml",
            "ic_santanderbank_icon.xml",
            "ic_usbank_icon.xml",
            "ic_westpaccomau_icon.xml",
            "ic_ing_icon.xml",
            "ic_mastercard_2019_logo.xml",
            "ic_scotiabank_icon.xml",
            "Alliant.png",
            "BHD.png",
            "BNP_Paribas.png",
            "BT.png",
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        private Integer[] mThumbIds = new Integer[]{
                R.drawable.ic_barclays_icon,
                R.drawable.ic_hsbc_icon,
                R.drawable.ic_bitcoin_icon,
                R.drawable.ic_axa,
                R.drawable.ic_visa,
                R.drawable.ic_bankofamerica_icon,
                R.drawable.ic_nabcomau_icon,
                R.drawable.ic_santanderbank_icon,
                R.drawable.ic_usbank_icon,
                R.drawable.ic_westpaccomau_icon,
                R.drawable.ic_ing_icon,
                R.drawable.ic_mastercard_2019_logo,
                R.drawable.ic_scotiabank_icon,
                R.drawable.alliant,
                R.drawable.airplane,
                R.drawable.amex,
                R.drawable.asset,
                R.drawable.anz,
                R.drawable.bancopopular,
                R.drawable.bank,
                R.drawable.bank_of_montreal,
                R.drawable.bankofchina,
                R.drawable.bankofqld,
                R.drawable.bankwest,
                R.drawable.banquecasino,
                R.drawable.bendigobank,
                R.drawable.bestbuy,
                R.drawable.bhd,
                R.drawable.bnp_paribas,
                R.drawable.bt,
                R.drawable.ca,
                R.drawable.capitalone,
                R.drawable.car,
                R.drawable.car1,
                R.drawable.car2,
                R.drawable.car3,
                ...
                R.drawable.commbank,
                R.drawable.commerzbank,
                R.drawable.davivienda,
                R.drawable.dental,
                R.drawable.deutschebank,
                ...
                R.drawable.irs,
                R.drawable.keybank,
                R.drawable.labanquepostale,
                R.drawable.leon,
                R.drawable.liability,
                R.drawable.lloydstsb,
                R.drawable.loans,
                R.drawable.medical,
                R.drawable.medical2,
                R.drawable.mitsubishi,
                R.drawable.nationwide,
                R.drawable.natwest,
                R.drawable.nsi,
                R.drawable.online,
                R.drawable.paypal,
                R.drawable.pcfinancial,
                R.drawable.populaire,
                R.drawable.popular,
                R.drawable.pound,
                R.drawable.present,
                R.drawable.progreso,
                R.drawable.publicbank,
                R.drawable.rabo,
                R.drawable.rbc,
                R.drawable.rbs,
